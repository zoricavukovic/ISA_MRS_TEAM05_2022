...
VALUES
    (nextval('users_id_gen'), 'False','Ap #225-738 At, Rd.','1979-03-13','zoka2000++virgina@gmail.com','Virginia','Calhoun',65,'KWL27BBR6XE','052-38-778-82','COTTAGE_OWNER',50),
    (nextval('users_id_gen'), 'False','4502 Semper Ave','2001-01-22','zoka2000++dolan@gmail.com','Dolan','Grimes',2,'LBX52LNU9UW','088-26-823-77','COTTAGE_OWNER',98);
...
VALUES
    ('True','Breaking things',1),
    ('True','Smoking',2),
    ('True','Pets',2),
    ('False','Children policies',3);
...
INSERT INTO additional_services (price,service_name,price_list_id, deleted)
VALUES
    (13,'food bar',1, false),
    (59,'drink bar',1, true),
    (65,'jacuzzi',1, true),
